...
export const en = {
  ...
  nutrition: {
    ...
    mealDetail: "Meal",
    loggedAt: "Logged at",
    addToMeal: "Add to this meal",
    alsoInMeal: "Also in this meal",
    savingPhoto: "Saving the photo…",
    photoNotSaved: "The meal was saved, but the photo didn't upload.",
    edit: "Edit",
    editFood: "Edit food",
    deleteFood: "Delete",
    addShort: "Add",
    nameRequired: "The name is required.",
    photoAddShort: "Add photo",
    photoChangeShort: "Change photo",
    photoRemoveShort: "Remove photo",
    photoUploadFailed: "The photo didn't upload. Try again, or remove the photo and save.",
    cancel: "Cancel",
  },
