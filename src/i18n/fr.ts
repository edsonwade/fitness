...
export const fr = {
  ...
  nutrition: {
    ...
    addToMeal: "Ajouter à ce repas",
    alsoInMeal: "Aussi dans ce repas",
    savingPhoto: "Enregistrement de la photo…",
    photoNotSaved: "Le repas est enregistré, mais la photo n'a pas été envoyée.",
    edit: "Modifier",
    editFood: "Modifier l'aliment",
    deleteFood: "Supprimer",
    addShort: "Ajouter",
    nameRequired: "Le nom est obligatoire.",
    photoAddShort: "Ajouter une photo",
    photoChangeShort: "Changer la photo",
    photoRemoveShort: "Retirer la photo",
    photoUploadFailed: "La photo n'a pas été envoyée. Réessaie, ou retire la photo et enregistre.",
    cancel: "Annuler",
  },
  ...
  editor: {
    ...
    videoAdd: 'Vidéo',
    videoChange: 'Changer la vidéo',
    videoRemove: 'Retirer la vidéo',
    videoSending: 'Envoi de la vidéo',
    videoTooBig: 'La vidéo dépasse 50 Mo. Coupe-la à quelques répétitions et réessaie.',
    videoFailed: 'La vidéo ne s’est pas envoyée. Réessaie, ou enregistre sans elle.',
    videoBadFile: 'Ce fichier n’est pas une vidéo.',
    videoOffline: 'Pas de connexion. Enregistre maintenant et ajoute la vidéo au retour d’internet.',
    mediaHint: 'La vidéo devient la démonstration pendant la séance. Sans vidéo, la photo s’affiche.',
    mediaEmpty: 'Ni photo ni vidéo',
    prescription: 'Prescription',
    prescriptionHint: 'Touche un nombre pour le choisir.',
    repsMin: 'Reps minimum',
    repsMax: 'Reps maximum',
    loadClear: 'Retirer la charge',
