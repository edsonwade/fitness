...
export const pt = {
  ...
  nutrition: {
    ...
    days: "dias",
    mealDetail: "Refeição",
    loggedAt: "Registado às",
    addToMeal: "Adicionar a esta refeição",
    alsoInMeal: "Também nesta refeição",
    savingPhoto: "A guardar a foto…",
    photoNotSaved: "A refeição ficou guardada, mas a foto não subiu.",
    edit: "Editar",
    editFood: "Editar alimento",
    deleteFood: "Apagar",
    addShort: "Adicionar",
    nameRequired: "O nome é obrigatório.",
    photoAddShort: "Pôr foto",
    photoChangeShort: "Trocar foto",
    photoRemoveShort: "Tirar foto",
    photoUploadFailed: "A foto não subiu. Tenta outra vez, ou tira a foto e guarda.",
    cancel: "Cancelar",
  },
  ...
  editor: {
    ...
    videoAdd: 'Vídeo',
    videoChange: 'Trocar vídeo',
    videoRemove: 'Tirar o vídeo',
    videoSending: 'A enviar o vídeo',
    videoTooBig: 'O vídeo passa de 50 MB. Corta-o a umas repetições e tenta outra vez.',
    videoFailed: 'O vídeo não subiu. Tenta outra vez, ou guarda sem ele.',
    videoBadFile: 'Esse ficheiro não é um vídeo.',
    videoOffline: 'Sem ligação. Guarda agora e põe o vídeo quando a internet voltar.',
    mediaHint: 'O vídeo passa a ser a demonstração no treino. Sem vídeo, aparece a foto.',
    mediaEmpty: 'Sem foto nem vídeo',
    prescription: 'Prescrição',
    prescriptionHint: 'Toca num número para o escolher.',
    repsMin: 'Reps mínimas',
    repsMax: 'Reps máximas',
    loadClear: 'Tirar a carga',
